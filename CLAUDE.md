...
This project is indexed by GitNexus as **SoloDShouse** (2745 symbols, 3567 relationships, 53 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
